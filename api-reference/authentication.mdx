...
Learn more about [application users](/docs/platform/concepts/application-users) and [authentication policies](/docs/platform/howto/set-authentication-policies).

## Related resources

- [Create authentication tokens](/docs/platform/howto/create_authentication_token)
- [Authentication tokens concept](/docs/platform/concepts/authentication-tokens)
