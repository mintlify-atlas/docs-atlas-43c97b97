...
<Tabs>
  <Tab title="PostgreSQL">
    The [AI Database Optimizer for PostgreSQL](https://aiven.io/docs/products/postgresql/howto/ai-insights) automatically:
...
- [AI Database Optimizer for PostgreSQL](https://aiven.io/docs/products/postgresql/howto/ai-insights)
