...
To start using Prometheus for monitoring metrics, [configure the Prometheus integration and set up the Prometheus server](/docs/platform/howto/integrations/prometheus-metrics).
...
- [Configure Prometheus integration](/docs/platform/howto/integrations/prometheus-metrics)
